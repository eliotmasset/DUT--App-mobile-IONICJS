...
import { b as getIonMode, c as config, a as isPlatform } from './ionic-global-ddef3a45.js';
import { j as clamp } from './helpers-cf6e85ee.js';
import { t as transition } from './index-5ad3bc52.js';
...
import { a as attachComponent, d as detachComponent } from './framework-delegate-bda125fb.js';
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!config.getBoolean('_testing')) {
          import('./tap-click-2553704d.js').then(module => module.startTapClick(config));
        }
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-dc6b4b49.js').then(module => module.startStatusTap());
        }
        if (config.getBoolean('inputShims', needInputShims())) {
          import('./input-shims-1eb64a0f.js').then(module => module.startInputShims(config));
        }
...
const RouterOutlet = class {
  ...
  async connectedCallback() {
    this.gesture = (await import('./swipe-back-7f7c9a3b.js')).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
      if (this.ani) {
